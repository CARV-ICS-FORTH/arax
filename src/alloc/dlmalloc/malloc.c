...
#endif
#endif /* ifdef NBPG */
#endif /* ifdef EXEC_PAGESIZE */
#endif /* ifdef WIN32 */
#endif /* if defined(BSD) || defined(DGUX) || defined(HAVE_GETPAGESIZE) */
#endif /* ifdef _SC_PAGE_SIZE */
...
#else /* if defined(__GNUC__) && (defined(__i386__) || defined(__x86_64__)) */
#define compute_bit2idx(X, I) \
    { \
        unsigned int Y = X - 1; \
