...
questions = [
  ...
  inquirer.Checkbox('Scope','What changed(select with space)',choices=['alloc', 'arch', 'async','core', 'utils', 'JVTalk', 'Vdf', 'Araxgrind', 'Other'],validate=warnMulti,ignore=hideScope),
