...
questions = [
  ...
  inquirer.Checkbox('Scope','What changed(select with space)',choices=['alloc', 'arch', 'async','core', 'utils', 'Controller', 'JVTalk', 'Vdf', 'Araxgrind', 'Other'],validate=warnMulti,ignore=hideScope),
