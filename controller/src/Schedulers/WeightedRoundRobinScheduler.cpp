 ...
 * system*/
utils_queue_s * WeightedRoundRobinScheduler::selectVirtualAcceleratorQueue(accelThread *th)
{
    cout << "Not Used" << endl;
    return 0;
}
 ...
 *
 */
arax_vaccel_s * WeightedRoundRobinScheduler::selectVirtualAcceleratorQueue(accelThread *th,
  size_t                                                                                id)
{
    /*init variables*/
    ...
    /****Step 2 : Select a VAQ from HIGH/LOW control queues*****/
    {
        ...
        if (utils_queue_used_slots(&(state->high))) {
            ...
            setClientCredits(vaqInfo->clientId, accelConf.group->getID(),
              -reduction_unit);
            #endif // ifndef REDUCTION_UNITS_FROM_EXEC_TIME
        }
...
} // WeightedRoundRobinScheduler::selectVirtualAcceleratorQueue
...
arax_task_msg_s * WeightedRoundRobinScheduler::selectTask(accelThread *th)
{
    ...
    myMutex.unlock();
    return arax_task;
} // WeightedRoundRobinScheduler::selectTask
...
void WeightedRoundRobinScheduler::loadreductionUnitFile()
{
    ...
    cout << "*****************************************************" << endl;
} // WeightedRoundRobinScheduler::loadreductionUnitFile
...
} // WeightedRoundRobinScheduler::time2ReductionUnits
