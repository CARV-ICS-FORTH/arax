...
{
    sizes[0] = sizeof(vine_throttle_s);
    sizes[1] = sizeof(vine_proc_s);
    sizes[2] = sizeof(vine_accel_s);
    sizes[3] = sizeof(vine_data_s);
    sizes[4] = sizeof(vine_task_msg_s);
    sizes[5] = sizeof(vine_pipe_s);
    sizes[6] = sizeof(utils_queue_s);
    sizes[7] = sizeof(vine_vaccel_s);
    sizes[8] = sizeof(utils_list_s);
}
